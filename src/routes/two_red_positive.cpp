...
{   
    ...
    wait(250,msec);
    MoveEncoderPID(TestPara, 100, -4, 0.4, -90 ,true); // drives after intaking
    wait(4,sec);
    RunRoller(-100); // spits out any potential opponent rings
    MoveEncoderPID(TestPara, 100, -5, 0.4, -90 ,true); // drives backwards a bit to get them out of the bot
